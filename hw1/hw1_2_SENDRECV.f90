program main
  ...
  double precision, allocatable :: b1a(:),b1b(:),b2a(:),b2b(:),b3a(:),b3b(:),b4a(:),b4b(:)
...
contains
  ...
  subroutine allocate_arrays()
    ...
    allocate(b1a(n1me+2))  ! +2 is for ghost cells for the 'corners'
    allocate(b1b(n1me+2))  ! +2 is for ghost cells for the 'corners'
    allocate(b2a(n2me))
    allocate(b2b(n2me))
    allocate(b3a(n1me+2))  ! +2 is for ghost cells for the 'corners'
    allocate(b3b(n1me+2))  ! +2 is for ghost cells for the 'corners'
    allocate(b4a(n2me))
    allocate(b4b(n2me))
  ...
  subroutine deallocate_arrays()
    deallocate(a,b,x,y,b1a,b2a,b3a,b4a,b1b,b2b,b3b,b4b)
